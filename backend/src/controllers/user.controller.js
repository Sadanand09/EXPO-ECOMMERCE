...
export async function addAddress(req, res) {
  try {
    ...
    //if this is set as default address, then unset the previous default address
    if (isDefault) {
...
export async function updateAddress(req, res) {
  try {
    ...
    const user = req.user;
    const address = user.addressed.id(addressId);
...
export async function deleteAddress(req, res) {
  try {
    ...
    user.addresses.pull(addressId); //removes from the list
    await user.save();
...
export async function removeFromWishlist(req, res) {
  try {
    ...
    //check if the product is not in wishlist
    if (!user.wishlist.includes(productId)) {
